...
int main()
{
    try{
        ...
        if (testEquality(aCSRList,cCSRList)) cout << "testEquality(aCSRList,cCSRList)) passed!" << endl;
        else cout << endl << "testEquality(aCSRList,cCSRList) failed!" << endl;
        ...
        // cout << endl << aCSRList.getAt(0,10,10) << endl;
    }
    catch (exception &e){
        cout << e.what() << endl;
    }
